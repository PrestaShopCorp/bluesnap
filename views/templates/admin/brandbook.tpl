...
<div class="bluesnap-desc-wrapper">
	...
	<div class="bluesnap-desc-content">
		...
		<div class="bluesnap-desc-col2">
			<div class="bluesnap-desc-subtitle"><em>{l s='Smarter' mod='bluesnap'}</em> {l s='payment gateway' mod='bluesnap'}</div>
			<ul class="bluesnap-desc-list">
				<li class="bluesnap-desc-list-item"><b>{l s='Intelligent payment routing' mod='bluesnap'}</b> {l s='to multiple acquiring banks' mod='bluesnap'}</li>
				<li class="bluesnap-desc-list-item"><b>{l s='Failover mechanism' mod='bluesnap'}</b> - {l s='re-charge failed transactions to save your sales' mod='bluesnap'}</li>
				<li class="bluesnap-desc-list-item"><b>{l s='Process globally' mod='bluesnap'}</b> {l s='with a variety of payment sources and originating countries' mod='bluesnap'}</li>
				<li class="bluesnap-desc-list-item">{l s='Checkout pages optimized for' mod='bluesnap'} <b>{l s='any device' mod='bluesnap'}</b></li>
			</ul>
		</div>
		<div class="bluesnap-desc-col3">
			...
			<ul class="bluesnap-desc-list bluesnap-desc-list-alt">
				...
				<li class="bluesnap-desc-list-item">{l s='Configure your' mod='bluesnap'} <a href="http://home.bluesnap.com/userguide/default.htm#WordManual/BuyNow" target="_blank"><b>{l s='callback URL' mod='bluesnap'}</b></a> {l s='and' mod='bluesnap'} <a href="http://home.bluesnap.com/integrationguide/default.htm#WordManual/Setting" target="_blank"><b>{l s='IPN URL' mod='bluesnap'}</b></a> {l s='in your BlueSnap account' mod='bluesnap'}</li>
				<li class="bluesnap-desc-list-item">{l s='Start accepting payments with BlueSnap' mod='bluesnap'}</li>
			</ul>
		</div>
		<div class="bluesnap-desc-hr"></div>
